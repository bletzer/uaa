...
public class LdapLoginAuthenticationManager implements AuthenticationManager, ApplicationEventPublisherAware, BeanNameAware {
    ...
    public Authentication authenticate(Authentication request) throws AuthenticationException {
        ...
        if (!(request.getPrincipal() instanceof LdapUserDetails)) {
        ...
        LdapUserDetails req = (LdapUserDetails) request.getPrincipal();
    ...
    protected UaaUser getUser(LdapUserDetails details, Map<String, String> info) {
